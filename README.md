...
|:-----------------------------:|:----------------------:|:---------------------:|:----------------------:|:----------------------:|
| оптимизированная на асемблере |           -            |        8,7 KiB        |        4812 ms         |      447               |
|             на C              |          -O            |        7,3 KiB        |        1345 ms         |      498               |
|             на C              |         -O2            |         8 KiB         |        516 ms          |      487               |
|             на C              |         -O3            |        9,2 KiB        |        498 ms          |      573               |
|             на C              |         -Os            |        6,4 KiB        |        1657 ms         |      400               |
